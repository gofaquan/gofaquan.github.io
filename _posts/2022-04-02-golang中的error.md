...
<img src="./images/image-20220402113513371.png" alt="image-20220402113513371" style="zoom: 67%;" />
...
<img src="./images/image-20220402132541683.png" alt="image-20220402132541683" style="zoom:50%;" />

#### Eliminate error handling by eliminating errors

通过 减少处理错误的代码 来减轻 错误处理 (阅读代码层面)

<img src="./images/image-20220402132749992.png" alt="image-20220402132749992" style="zoom:33%;" />

这样可以更简介明了                 <a name="auth_code"> (为本文后续做个铺垫)</a>

<img src="./images/image-20220402132908462.png" alt="image-20220402132908462" style="zoom:33%;" />
